...
$chkAdmin = $this->db->where(['email' =>$email ,'password' =>$password ])
         ...
         { 
             ...
             public function insertCoadmin($data){
             ...
             return $this->db->insert('tbl_users',$data);
                  ...
                  public function insertStudent($data){
                   ...
                   public function viewAllColleges(){
                    ...
                    $this->db->select(['tbl_college.college_id' ,'tbl_college.collegename','tbl_student.id','tbl_student.email','tbl_student.gender','tbl_student.course','tbl_student.studentname']);
...
// return  $this->db->where('id',$id)->delete('tbl_student',$id); not working.
